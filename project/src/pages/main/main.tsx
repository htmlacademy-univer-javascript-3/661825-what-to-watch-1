...
import {SHOW_MORE_STEP_COUNT} from '../../const';
...
function Main() {
  ...
  const genres = [ALL_GENRES].concat([...new Set(films.map((film) => film.genre))]).slice(0, 10);
    ...
    <>
      ...
      <div className="page-content">
        <section className="catalog">
          ...
          {
            showedFilmsCount + SHOW_MORE_STEP_COUNT < films.filter(
              (film) => film.genre === currentGenre || currentGenre === ALL_GENRES).length
